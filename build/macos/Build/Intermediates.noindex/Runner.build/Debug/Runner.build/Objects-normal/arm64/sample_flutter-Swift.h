...
#ifndef SAMPLE_FLUTTER_SWIFT_H
#define SAMPLE_FLUTTER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="sample_flutter",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC14sample_flutter11AppDelegate")
...
SWIFT_CLASS("_TtC14sample_flutter17MainFlutterWindow")
